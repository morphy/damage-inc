            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Edytuj zlecenie</h5>
                </div>
                <div class="card-body">
                  <form action="<?php echo url('jobs/saveEdit/');?><?php echo $data['job'][0]['id_zlecenie']; ?>" method="post">
                    <div class="form-group">
                      <label for="nazwa">Nazwa</label>
                      <input type="text" maxlength="40" class="form-control" id="nazwa" placeholder="Nazwa" name="nazwa" required value="<?php echo $data['job'][0]['nazwa']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="opis">Opis</label>
                      <input type="text" class="form-control" id="opis" placeholder="Opis" name="opis" value="<?php echo $data['job'][0]['opis']; ?>">
                    </div>
                    <div class="form-group">
                      <label for="data">Data</label>
                      <input type="date" class="form-control" id="data" placeholder="RRRR-MM-DD" name="data" required value="<?php echo $data['job'][0]['data']; ?>">
                    </div>
                    <div class="form-group">
                      <div class="custom-control custom-radio">
                        <input type="radio" id="no" name="ukonczone" class="custom-control-input" value="0" <?php if($data['job'][0]['ukonczone'] == 0) echo 'checked'; ?>>
                        <label class="custom-control-label" for="no">Nieukończone</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input type="radio" id="yes" name="ukonczone" class="custom-control-input" value="1" <?php if($data['job'][0]['ukonczone'] == 1) echo 'checked'; ?>>
