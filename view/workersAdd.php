          ...
          <div class="row">
            <div class="col-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="<?php echo url('workers/save');?>" method="post">
                    <div class="form-group">
                      <label for="imie">Imię</label>
                      <input type="text" maxlength="20" class="form-control" id="imie" placeholder="Imię" name="imie" required>
                    </div>
                    <div class="form-group">
                      <label for="nazwisko">Nazwisko</label>
                      <input type="text" maxlength="40" class="form-control" id="nazwisko" placeholder="Nazwisko" name="nazwisko" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <div class="custom-control custom-radio">
                        <input type="radio" id="normal" name="rodzaj" class="custom-control-input" value="0" checked>
                        <label class="custom-control-label" for="normal">Zwykły pracownik</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input type="radio" id="manager" name="rodzaj" class="custom-control-input" value="1">
