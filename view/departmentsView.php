            ...
            <div class="col-12 pt-3">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Lista działów</h5>
                </div>
                <table class="table table-dark table-striped">
                    ...
                    <tbody>
                      <?php foreach($data['deps'] as $row): ?>
                        <tr>
                          <td><?php echo $row['id_dzial']; ?></td>
                          <td><?php echo $row['nazwa']; ?></td>
                          <td><?php echo ($row['audyt'] == 1) ? '<span class="text-success">tak</span>' : '<span class="text-danger">nie</span>'; ?></td>
                          <td>
                            <a href="<?php echo url('departments/edit/'); ?><?php echo $row['id_dzial']; ?>">
                              <i class="pe-7s-note"></i>
                            </a>
                          </td>
                          <td>
                            <a href="<?php echo url('departments/delete/'); ?><?php echo $row['id_dzial']; ?>">
