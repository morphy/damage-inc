            ...
            <div class="col-12 pt-3">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Lista przydziałów</h5>
                </div>
                <table class="table table-dark table-striped">
                    ...
                    <tbody>
                      <?php foreach($data['assignments'] as $row): ?>
                        <tr>
                          <td><?php echo $row['imie'].' '.$row['nazwisko']; ?></td>
                          <td><?php echo $row['nazwa']; ?></td>
                          <td>
                            <a href="<?php echo url('jobs/deleteAssignment/'); ?><?php echo $row['id_zlecenie'].'-'.$row['id_pracownik']; ?>">
