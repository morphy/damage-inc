            ...
            <div class="col-12 pt-3">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Lista pracowników</h5>
                </div>
                <table class="table table-dark table-striped">
                    ...
                    <tbody>
                      <?php foreach($data['users'] as $row): ?>
                        <tr>
                          <td><?php echo $row['id_pracownik']; ?></td>
                          <td><?php echo $row['imie']; ?></td>
                          <td><?php echo $row['nazwisko']; ?></td>
                          <td><?php echo $row['nazwa']; ?></td>
                          <td><?php echo ($row['menedzer'] == 1) ? '<span class="text-success">tak</span>' : '<span class="text-danger">nie</span>'; ?></td>
                          <td>
                            <a href="<?php echo url('workers/edit/'); ?><?php echo $row['id_pracownik']; ?>">
                              <i class="pe-7s-note"></i>
                            </a>
                          </td>
                          <td>
                            <a href="<?php echo url('workers/delete/'); ?><?php echo $row['id_pracownik']; ?>">
