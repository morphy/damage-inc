            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">Dodaj dział</h5>
                </div>
                <div class="card-body">
                  <form action="<?php echo url('departments/save');?>" method="post">
                    <div class="form-group">
                      <label for="nazwa">Nazwa</label>
                      <input type="text" maxlength="20" class="form-control" id="nazwa" placeholder="Nazwa" name="nazwa" required>
                    </div>
                    <div class="form-group">
                      <div class="custom-control custom-radio">
                        <input type="radio" id="noaudit" name="audyt" class="custom-control-input" value="0" checked>
                        <label class="custom-control-label" for="noaudit">Brak audytu</label>
                      </div>
                      <div class="custom-control custom-radio">
                        <input type="radio" id="audit" name="audyt" class="custom-control-input" value="1">
